...
class App1(tkinter.Frame):
    def __init__(self, master=None):
        ...
        self.save["text"] = "ファイルパスを保存"  # ボタンのテキスト
    ...
    def make_Func(self):
        ...
        f = open('setscript.txt', 'r', encoding='UTF-8')
        while True:
            data = f.readline()
            if data == '':
                break
            ...
            save = pyautogui.locateOnScreen('img/save.png', confidence=0.9)
